...
from chat.utils.model_loader import ModelLoader
from chat.logger import GLOBAL_LOGGER as log
from chat.exception.exception_handler import DocumentPortalException
import json
import uuid
from datetime import datetime
from chat.utils.file_io import save_uploaded_files
from chat.utils.document_ops import load_documents
from chat.utils.session_cleanup import touch_session_meta
import hashlib
import sys
...
class ChatIngestor:
    def __init__(self,
        ...
        try:
            ...
            # Track initial metadata for this session for later cleanup/TTL.
            touch_session_meta(self.faiss_dir, self.session_id)
    ...
    def built_retriver( self,
        ...
        *,
        ...
        try:
            ...
            # Update session metadata so cleanup policies know it is active.
            touch_session_meta(self.faiss_dir, self.session_id)
